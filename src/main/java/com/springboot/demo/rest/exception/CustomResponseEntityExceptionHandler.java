...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public final ResponseEntity<Object> handleStudentNotFoundException(
      StudentNotFoundException studentNotFoundException, WebRequest webRequest) {
    ExceptionResponse exceptionResponse =
        new ExceptionResponse(
            new Date(), studentNotFoundException.getMessage(), webRequest.getDescription(false));
    return new ResponseEntity<>(exceptionResponse, HttpStatus.NOT_FOUND);
  }

  @ExceptionHandler(DuplicateStudentFoundException.class)
  public final ResponseEntity<Object> handleDuplicateStudentFoundException(
      DuplicateStudentFoundException duplicateStudentFoundException, WebRequest webRequest) {
    ExceptionResponse exceptionResponse =
        new ExceptionResponse(
            new Date(),
            duplicateStudentFoundException.getMessage(),
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    ExceptionResponse exceptionResponse =
        new ExceptionResponse(new Date(), "Validation Failed", errorMessages.toString());
